...
const niches = [
  ...
  },
  {
    id: "food-beverage",
    title: "Food & Beverage", 
    description: "Specialty foods, drinks, ingredients",
    icon: Coffee,
  },
  {
    id: "home-garden",
  ...
  },
  {
    ...
    description: "Tech accessories, smart devices",
    icon: Smartphone,
  },
  {
    id: "gaming",
    title: "Gaming & Entertainment",
    description: "Video games, toys, hobbies",
    icon: Gamepad,
  },
  {
    id: "baby-kids",
    title: "Baby & Kids",
    description: "Children's clothing, toys, gear",
    icon: Baby,
  },
  {
    id: "pets",
  ...
  },
  {
    ...
    description: "Prints, artwork, equipment",
    icon: Camera,
  },
  {
    id: "music",
  ...
  },
  {
    id: "books-media",
    title: "Books & Media",
    description: "Books, digital content, courses",
    icon: Book,
  },
  {
    id: "automotive",
  ...
  },
  {
    id: "flowers-gifts",
    title: "Flowers & Gifts",
    description: "Bouquets, gift baskets",
    icon: Flower2,
  }
];
...
const NicheStep: React.FC<NicheStepProps> = ({ selectedNiches, setSelectedNiches }) => {
  ...
  return React.createElement('div', { className: "space-y-3" },
    ...
    React.createElement('div', { className: "text-center" },
      React.createElement('h1', { className: "text-xl font-semibold text-white" }, 
        "What's your primary market focus?"
      ),
      React.createElement('p', { className: "text-sm text-zinc-400 mt-1" },
        `Select up to 3 niches (${selectedNiches.length}/3 selected)`
      )
    ),

    // Simple Search Only
    React.createElement('div', { className: "relative max-w-md mx-auto" },
    ...
    // No results - minimal
    filteredNiches.length === 0 && React.createElement('div', { 
      className: "text-center py-2 text-zinc-400 text-sm" 
    },
